...
```
[net] session start role=host room=<CODE> protocol=v13 transport=WebRTC (menu lobby)
[net] session start role=join room=<CODE> protocol=v13 transport=WebRTC (menu lobby)
```
