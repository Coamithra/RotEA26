...
public class Background : Scene
{
	...
	public Background(Game game)
		: base(game)
	{
		((DrawableGameComponent)this).DrawOrder = 0;
	...
	protected void fadeBackBufferToWhite(float factor)
	{
		...
		base.SpriteBatch.Draw(blank, new Rectangle(0, 0, ((Viewport)(ref viewport)).Width, ((Viewport)(ref viewport)).Height), new Color(byte.MaxValue, byte.MaxValue, byte.MaxValue, (byte)num));
	}
	...
	protected override void LoadContent()
	{
		...
		{
			_ = ((DrawableGameComponent)this).GraphicsDevice.PresentationParameters;
			rendertarget = new RenderTarget2D(((DrawableGameComponent)this).GraphicsDevice, 800, 600, 1, (SurfaceFormat)2, (RenderTargetUsage)1);
		}
	}
