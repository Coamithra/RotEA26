...
internal class Demo2 : GameScene
{
	...
	protected override void PopulateEventList()
	{
		...
		Wait(3f);
		StationaryWave(1f, 3f, 0f, 1f, 0f, 0f);
		WaitEvent waitEvent2 = new WaitEvent(((GameComponent)this).Game, 3f);
		...
		Wait(3f);
		StationaryWave(1f, 3f, 0f, 1f, 0f, 0f);
		waitEvent2 = new WaitEvent(((GameComponent)this).Game, 3f);
		eventList.AddEvent(waitEvent2, halting: false);
		waitEvent2.OnFinished += spawnStationaryBoss;
		StationaryWave(1f, 3f, 0f, 1f, 0f, 0f);
		Wait(3f);
		...
		waitEvent2 = new WaitEvent(((GameComponent)this).Game, 10f);
		...
		waitEvent2 = new WaitEvent(((GameComponent)this).Game, 6f);
		eventList.AddEvent(waitEvent2, halting: true);
		waitEvent2.OnFinished += speedup;
		eventList.AddHalt();
		waitEvent2 = new WaitEvent(((GameComponent)this).Game, 2f);
		eventList.AddEvent(waitEvent2, halting: true);
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		...
		eventList.AddHalt();
		UnlockEvent gameEvent = new UnlockEvent(((GameComponent)this).Game, "Mechanical Friends", Unlockables.Items.Friends, AnimatedMessage.UnlockType.cheat, level);
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
		waitEvent2 = new WaitEvent(((GameComponent)this).Game, 0.1f);
		eventList.AddEvent(waitEvent2, halting: true);
		eventList.AddHalt();
	...
	{
		WaitEvent gameEvent = new WaitEvent(((GameComponent)this).Game, time);
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
	}
