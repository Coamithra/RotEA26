...
internal class Demo3 : GameScene
{
	...
	protected override void PopulateEventList()
	{
		...
		SkullSpawner gameEvent = new SkullSpawner(((GameComponent)this).Game, 0f, 1f, maze: true, bonusonly: false);
		...
		eventList.AddEvent(walls, halting: true);
		eventList.AddHalt();
		UnlockEvent gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Mechanical Friends", Unlockables.Items.Friends, AnimatedMessage.UnlockType.cheat, level);
