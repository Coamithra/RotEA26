...
internal class Explosion : AlienDrawableGameComponent
{
	...
	public override void Initialize()
	{
		...
		base.Initialize();
		SmokeDrawer smokeDrawer = SmokeDrawer.NewSmokeDrawer(collection, ((GameComponent)this).Game);
	...
	public override void Update(GameTime gameTime)
	{
		...
		base.Speed = MathHelper.Lerp(((Vector2)(ref backgroundSpeed)).Length() * 0.45f, 0f, backgroundimpulsetimer.Normalized);
