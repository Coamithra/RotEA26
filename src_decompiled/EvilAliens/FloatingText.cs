	...
	public void Draw(SpriteFont font, SpriteBatchWrapper wrapper)
	{
		...
		if (!done)
		{
			...
			case ShowType.scrollup:
			{
				...
				((Color)(ref color3))._002Ector((byte)0, (byte)128, (byte)128, b2);
			...
			case ShowType.pop:
			{
				...
				((Color)(ref color))._002Ector(byte.MaxValue, byte.MaxValue, (byte)128, b);
				Color color2 = default(Color);
				((Color)(ref color2))._002Ector((byte)118, (byte)118, (byte)21, b);
