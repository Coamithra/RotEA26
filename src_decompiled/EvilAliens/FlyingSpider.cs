...
internal class FlyingSpider : KillableAlien
{
	...
	public override void Initialize()
	{
		...
		if (isbackground)
		{
			...
			base.Speed = ((Vector2)(ref backgroundSpeed)).Length() * 1.11f;
		...
		else
		{
			...
			base.Speed = ((Vector2)(ref backgroundSpeed2)).Length() * 1.35f;
			((DrawableGameComponent)this).DrawOrder = 20;
	...
	public override void Draw(GameTime gameTime)
	{
		...
		((Vector2)(ref val))._002Ector((float)(-num2) / 2f, (float)(-num3) / 2f);
	...
	protected override void KilledBy(ICollidable other, bool isComboGenerator)
	{
		...
		if (!base.IsDead)
		{
			...
			bloodExplosion2.Setup(position, 5f, 0.75f, MathHelper.Min(((Vector2)(ref speedVector)).Length(), 0.24f), MyMath.VectorToAngle(base.SpeedVector));
			...
			bloodExplosion3.Setup(position2, 3f, 0.5f, MathHelper.Min(((Vector2)(ref speedVector2)).Length(), 0.24f), MyMath.VectorToAngle(base.SpeedVector));
			bloodExplosion.MakeGreen();
			collection.Add((GameComponent)(object)bloodExplosion);
