...
public class Game1 : Game
{
	...
	public Game1()
	{
		...
		content = new ContentManager((IServiceProvider)((Game)this).Services, "Content");
		inputHandler = new InputHandler();
		((Game)this).Services.AddService(typeof(IInputHandlerService), (object)inputHandler);
		...
		((Game)this).Services.AddService(typeof(ISoundManagerService), (object)soundManager);
		((Game)this).IsFixedTimeStep = false;
		spriteBatchWrapper = new SpriteBatchWrapper((Game)(object)this);
		((Game)this).Services.AddService(typeof(ISpriteBatchWrapperService), (object)spriteBatchWrapper);
		cursor = new MousePointer((Game)(object)this);
		ServiceHelper.Add((IMousePointerService)cursor);
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)cursor);
		...
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)oracle);
		...
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)bloom);
	...
	{
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)spriteBatchWrapper);
		...
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)splashScene);
		...
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)awardmentBlade);
	...
	private void startScreen_OnFinished(object sender)
	{
		...
		((Collection<IGameComponent>)(object)((Game)this).Components).Remove((IGameComponent)(object)startScreen);
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)menuScene);
	}
	...
	protected override void LoadContent()
	{
		...
		blackPixel = ((Game)this).Content.Load<Texture2D>("Content/GFX/Splash/blank");
		...
		resolveTarget = new ResolveTexture2D(((Game)this).GraphicsDevice, backBufferWidth, backBufferHeight, 1, backBufferFormat);
		isWideScreen = GraphicsAdapter.DefaultAdapter.IsWideScreen;
		if (!isWideScreen)
		{
			Settings.GetInstance().Scale = 0.9f;
		}
		gamma = ((Game)this).Content.Load<Effect>("Content/GFX/Effects/gamma");
	}
	...
	{
		splashScene.Unload();
		((Collection<IGameComponent>)(object)((Game)this).Components).Remove((IGameComponent)(object)splashScene);
		((Collection<IGameComponent>)(object)((Game)this).Components).Add((IGameComponent)(object)startScreen);
	}
	...
	protected override void Update(GameTime gameTime)
	{
		...
		MyDebug.Assert(((Collection<IGameComponent>)(object)((Game)this).Components).Contains((IGameComponent)(object)gamerServicesComponent));
		...
		if (num != 100 || slowmotion != 1f)
		{
			...
			gameTime = new GameTime(gameTime.TotalRealTime, gameTime.ElapsedRealTime, new TimeSpan((long)((float)gameTime.TotalGameTime.Ticks * num2)), new TimeSpan((long)((float)gameTime.ElapsedGameTime.Ticks * num2)));
		}
	...
	private void DrawInner(GameTime gameTime)
	{
		...
		((Game)this).GraphicsDevice.ResolveBackBuffer(resolveTarget);
		...
		if (Settings.GetInstance().HideSafeArea)
		{
			...
			spriteBatchWrapper.Draw(blackPixel, new Rectangle(0, 0, 800, ((Rectangle)(ref safeZone)).Top), Color.Black);
			spriteBatchWrapper.Draw(blackPixel, new Rectangle(0, 0, ((Rectangle)(ref safeZone)).Left, 600), Color.Black);
			spriteBatchWrapper.Draw(blackPixel, new Rectangle(0, ((Rectangle)(ref safeZone)).Bottom, 800, 600), Color.Black);
			spriteBatchWrapper.Draw(blackPixel, new Rectangle(((Rectangle)(ref safeZone)).Right, 0, 800, 600), Color.Black);
			spriteBatchWrapper.Flush();
		}
		if (wantExit)
		{
	...
	internal void Reset()
	{
		...
		foreach (IGameComponent item in (Collection<IGameComponent>)(object)((Game)this).Components)
		{
			list.Add(item);
		}
		foreach (IGameComponent item2 in list)
		{
			...
			{
				((Collection<IGameComponent>)(object)((Game)this).Components).Remove(item2);
			}
		}
