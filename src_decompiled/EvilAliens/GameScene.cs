...
internal abstract class GameScene : Scene
{
		...
		: base(game)
	{
		...
		darkener = new Darkener(((GameComponent)this).Game, "select", "back");
		pausedScene = new PausedScene(((GameComponent)this).Game);
		...
		exitConfirmationMenu = new ConfirmationMenu(((GameComponent)this).Game, "Are you sure you want to exit this game session?");
	...
	public override void Initialize()
	{
		...
		pausestopper.Stop();
		Background.Reset();
		((Collection<IGameComponent>)(object)((GameComponent)this).Game.Components).Add((IGameComponent)(object)Background);
		((Collection<IGameComponent>)(object)((GameComponent)this).Game.Components).Add((IGameComponent)(object)Foreground);
		eventList.Reset();
	...
	protected virtual void PreloadGraphicalContent()
	{
		...
		LazerGenerator lazerGenerator = LazerGenerator.NewLazerGenerator(Collection, ((GameComponent)this).Game);
		...
		lazer.SetupSingleShot(new Vector2(-1000f, -1000f), (float)Math.PI, 10f, playSound: false);
		Collection.Add((GameComponent)(object)lazer);
		u = UFO.NewUFO(Collection, ((GameComponent)this).Game);
	...
	protected void TestBlocks()
	{
		...
		for (int i = 0; i < 800 / num; i++)
		{
			...
			{
				TestBlock testBlock = TestBlock.NewTestBlock(Collection, ((GameComponent)this).Game);
	...
	private void UpdateGameOver(GameTime gameTime)
	{
		...
		{
			defeatmessage = AnimatedMessage.NewAnimatedMessage(Collection, ((GameComponent)this).Game);
	...
	private void takeScreenShot()
	{
		...
		if (((Collection<IGameComponent>)(object)((GameComponent)this).Game.Components).Contains((IGameComponent)(object)this))
		{
			if (MyScreenShot == null)
			{
				MyScreenShot = new ResolveTexture2D(((DrawableGameComponent)this).GraphicsDevice, ((DrawableGameComponent)this).GraphicsDevice.PresentationParameters.BackBufferWidth, ((DrawableGameComponent)this).GraphicsDevice.PresentationParameters.BackBufferHeight, 1, ((DrawableGameComponent)this).GraphicsDevice.PresentationParameters.BackBufferFormat);
			}
			try
			{
				((DrawableGameComponent)this).GraphicsDevice.ResolveBackBuffer(MyScreenShot);
			}
			catch (Exception)
			{
			}
