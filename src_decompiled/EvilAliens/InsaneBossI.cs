...
internal class InsaneBossI : GameScene
{
	...
	{
		f = new Floor(((GameComponent)this).Game);
	...
	protected override void PopulateEventList()
	{
		...
		MessageEvent messageEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning, 2.5f);
		...
		BonusSpawner gameEvent = new BonusSpawner(((GameComponent)this).Game, 0f, 0.05f, randomly: false);
		eventList.AddEvent(gameEvent, halting: false);
		bossSpawner.LinkWith(gameEvent);
		UfoSpawner gameEvent2 = new UfoSpawner(((GameComponent)this).Game, 0f, 2f, big: false);
		...
		eventList.AddHalt();
		Wait(5f);
		messageEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning, 3.2f);
		messageEvent.SetupAsWarning(4.712389f);
		eventList.AddEvent(messageEvent, halting: true);
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		JunkBossSpawner junkBossSpawner = new JunkBossSpawner(((GameComponent)this).Game);
		gameEvent2 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.12f, big: false);
		eventList.AddEvent(gameEvent2, halting: false);
		junkBossSpawner.LinkWith(gameEvent2);
		gameEvent = new BonusSpawner(((GameComponent)this).Game, 0f, 0.046f, randomly: true);
		eventList.AddEvent(gameEvent, halting: false);
		junkBossSpawner.LinkWith(gameEvent);
		gameEvent2 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.053f, big: true);
		eventList.AddEvent(gameEvent2, halting: false);
		junkBossSpawner.LinkWith(gameEvent2);
		...
		Wait(3f);
		gameEvent = new BonusSpawner(((GameComponent)this).Game, 0f, 0.2f, randomly: true);
		gameEvent.SetMars();
		...
		gameEvent2 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.2f, big: true);
		eventList.AddEvent(gameEvent2, halting: false);
		spiderBossEvent.LinkWith(gameEvent2);
		gameEvent = new BonusSpawner(((GameComponent)this).Game, 0f, 0.08f, randomly: false);
		eventList.AddEvent(gameEvent, halting: false);
		spiderBossEvent.LinkWith(gameEvent);
		gameEvent2 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.15f, big: true);
		...
		Wait(5f);
		StarMineSpawner gameEvent3 = new StarMineSpawner(((GameComponent)this).Game, 5f, 0.7f);
		...
		eventList.SetLastEventAsCheckPoint();
		Wait(5f);
		SkullSpawner gameEvent4 = new SkullSpawner(((GameComponent)this).Game, 0f, 0.1f, maze: false, bonusonly: true);
		eventList.AddEvent(gameEvent4, halting: false);
		gameEvent3 = new StarMineSpawner(((GameComponent)this).Game, 0f, 0.75f);
		eventList.AddEvent(gameEvent3, halting: false);
		junkBossSpawner = new JunkBossSpawner(((GameComponent)this).Game);
		...
		eventList.SetLastEventAsCheckPoint();
		Wait(3f);
		FakeBossSpawner gameEvent5 = new FakeBossSpawner(((GameComponent)this).Game);
		...
		BrainBossSpawner brainBossSpawner = new BrainBossSpawner(((GameComponent)this).Game, challenge: true);
	...
	{
		WaitEvent waitEvent = new WaitEvent(((GameComponent)this).Game, seconds);
		eventList.AddEvent(waitEvent);
		eventList.AddHalt();
		return waitEvent;
	}
