...
internal class InstructionsMenu : DrawableGameComponent
{
	...
	public override void Draw(GameTime gameTime)
	{
		...
		case HelpText.Displays.Powerups:
		{
			...
			((Color)(ref color2))._002Ector(new Vector4(0.37f, 0.63f, 1f, 1f));
		...
		case HelpText.Displays.Combo:
		{
			...
			((Color)(ref color))._002Ector(new Vector4(0.37f, 0.63f, 1f, 1f));
	...
	private void ExplainPowerup(Powerup.PowerupType powerupType, float y, string p)
	{
		...
		spriteBatchWrapper.DrawString(text, position, new Color(new Vector4(((Color)(ref val)).ToVector3(), 1f)), 0f, Vector2.Zero, 0.8f, (SpriteEffects)0, 0f);
		spriteBatch.Flush();
