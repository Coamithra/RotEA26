...
internal class Level1 : GameScene
{
	...
	protected override void PopulateEventList()
	{
		...
		DevCommentEvent gameEvent = new DevCommentEvent(((GameComponent)this).Game, DevCommentEvent.CommentVersion.level1_1);
		...
		Lvl1StartDemoEvent lvl1StartDemoEvent = new Lvl1StartDemoEvent(((GameComponent)this).Game);
		...
		UfoFormationSpawner gameEvent2 = new UfoFormationSpawner(((GameComponent)this).Game, 6);
		eventList.AddEvent(gameEvent2);
		eventList.AddHalt();
		gameEvent2 = new UfoFormationSpawner(((GameComponent)this).Game, 1);
		eventList.AddEvent(gameEvent2, halting: false);
		BonusSpawner gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 20f, 0.1f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		UfoSpawner gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 20f, 1f, big: false);
		eventList.AddEvent(gameEvent4);
		eventList.AddHalt();
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 5f, 0.1f, big: false);
		eventList.AddEvent(gameEvent4);
		eventList.AddHalt();
		MessageEvent gameEvent5 = new MessageEvent(((GameComponent)this).Game, "Get ready!", SoundManager.Texts.GetReady);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent2 = new UfoFormationSpawner(((GameComponent)this).Game, 12);
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 10f, 0.2f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		eventList.SetLastEventAsCheckPoint();
		gameEvent2.LinkWith(gameEvent3);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 0f, 1.33f, big: false);
		gameEvent4.SetupThreeDirectional();
		eventList.AddEvent(gameEvent4, halting: false);
		gameEvent2.LinkWith(gameEvent4);
		eventList.AddEvent(gameEvent2);
		eventList.AddHalt();
		gameEvent5 = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 5f, 1.5f, big: false);
		eventList.AddEvent(gameEvent4);
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		gameEvent4.OnFinished += spawner_OnFinished;
		gameEvent5 = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning, 2.5f);
		gameEvent5.SetupAsWarning(MyMath.VectorToAngle(new Vector2(-800f, -600f)));
		eventList.AddEvent(gameEvent5, halting: true);
		eventList.AddHalt();
		AsteroidSpawner gameEvent6 = new AsteroidSpawner(((GameComponent)this).Game, 42f, 4f, startWithBig: true);
		eventList.AddEvent(gameEvent6, halting: true);
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 10f, 0.3f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 10f, 5f, big: false);
		...
		UnlockEvent gameEvent7 = new UnlockEvent(((GameComponent)this).Game, "Space Dodge!", Unlockables.Items.SpaceDodge, AnimatedMessage.UnlockType.challenge, level);
		...
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 40f, 0.15f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 40f, 1.3f, big: false);
		eventList.AddEvent(gameEvent4, halting: true);
		brainSpawner = new BrainSpawner(((GameComponent)this).Game, 30f, 0.06f, wrapping: true);
		eventList.AddEvent(brainSpawner, halting: true);
		eventList.AddHalt();
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 10f, 1.5f, big: false);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent7 = new UnlockEvent(((GameComponent)this).Game, "Braineroids!", Unlockables.Items.Braineroids, AnimatedMessage.UnlockType.challenge, level);
		eventList.AddEvent(gameEvent7, halting: true);
		eventList.AddHalt();
		gameEvent5 = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 10f, 3f, big: false);
		eventList.AddEvent(gameEvent4, halting: false);
		eventList.SetLastEventAsCheckPoint();
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 10f, 0.3f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent = new DevCommentEvent(((GameComponent)this).Game, DevCommentEvent.CommentVersion.level1_2);
		eventList.AddEvent(gameEvent, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 10f, 0.33f, big: true);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 24f, 0.1f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 24f, 3f, big: false);
		eventList.AddEvent(gameEvent4, halting: true);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 24f, 0.5f, big: true);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent5 = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent5.OnFinished += message_OnFinished2;
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 6f, 2f, big: false);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.SetLastEventAsCheckPoint();
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 6f, 0.4f, big: true);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent5 = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning, 2.5f);
		...
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 0f, 0.05f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		bossSpawner.LinkWith(gameEvent3);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 0f, 2f, big: false);
		eventList.AddEvent(gameEvent4, halting: false);
		bossSpawner.LinkWith(gameEvent4);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.33f, big: true);
		eventList.AddEvent(gameEvent4, halting: false);
		bossSpawner.LinkWith(gameEvent4);
		...
		gameEvent5 = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent = new DevCommentEvent(((GameComponent)this).Game, DevCommentEvent.CommentVersion.level1_3);
		eventList.AddEvent(gameEvent, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 35f, 4f, big: false);
		gameEvent4.SetupThreeDirectional();
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.SetLastEventAsCheckPoint();
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 35f, 0.125f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 35f, 0.66f, big: true);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 10f, 2.25f, big: false);
		eventList.AddEvent(gameEvent4, halting: true);
		eventList.AddHalt();
		gameEvent5 = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent5, halting: false);
		gameEvent = new DevCommentEvent(((GameComponent)this).Game, DevCommentEvent.CommentVersion.level1_4);
		eventList.AddEvent(gameEvent, halting: false);
		...
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 10f, 0.5f, randomly: false);
		eventList.AddEvent(gameEvent3, halting: false);
		gameEvent5 = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning, 3.2f);
		gameEvent5.SetupAsWarning(4.712389f);
		eventList.AddEvent(gameEvent5, halting: true);
		eventList.AddHalt();
		JunkBossSpawner junkBossSpawner = new JunkBossSpawner(((GameComponent)this).Game);
		junkBossSpawner.OnFinished += invuln;
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.12f, big: false);
		eventList.AddEvent(gameEvent4, halting: false);
		junkBossSpawner.LinkWith(gameEvent4);
		gameEvent3 = new BonusSpawner(((GameComponent)this).Game, 0f, 0.046f, randomly: true);
		eventList.AddEvent(gameEvent3, halting: false);
		junkBossSpawner.LinkWith(gameEvent3);
		gameEvent4 = new UfoSpawner(((GameComponent)this).Game, 0f, 0.053f, big: true);
		eventList.AddEvent(gameEvent4, halting: false);
		junkBossSpawner.LinkWith(gameEvent4);
		eventList.AddEvent(junkBossSpawner, halting: true);
		eventList.AddHalt();
		gameEvent7 = new UnlockEvent(((GameComponent)this).Game, "Infinite Lives", Unlockables.Items.InfiniteLives, AnimatedMessage.UnlockType.cheat, level);
		eventList.AddEvent(gameEvent7, halting: true);
		eventList.AddHalt();
		gameEvent7 = new UnlockEvent(((GameComponent)this).Game, "Next Mission!", Unlockables.Items.Level2, AnimatedMessage.UnlockType.level, level);
		eventList.AddEvent(gameEvent7, halting: true);
		eventList.AddHalt();
		gameEvent7 = new UnlockEvent(((GameComponent)this).Game, "Insane Difficulty", Unlockables.Items.InsaneDifficulty, AnimatedMessage.UnlockType.difficulty, level);
		eventList.AddEvent(gameEvent7, halting: true);
		eventList.AddHalt();
