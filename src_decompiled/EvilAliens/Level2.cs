...
internal class Level2 : GameScene
{
		...
		: base(game, Levels.Level2)
	{
		...
		floor = new Floor(((GameComponent)this).Game);
	}
	...
	protected override void PreloadGraphicalContent()
	{
		...
		preloadBoss = SpiderBoss.NewSpiderBoss(Collection, ((GameComponent)this).Game);
	...
	protected override void PopulateEventList()
	{
		...
		UfoWave(4.2f, 3.5f);
		Wait(6f);
		MessageEvent gameEvent = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent, halting: false);
		UfoSpawner ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 0.5f, big: false);
		ufoSpawner.SetupMars();
		eventList.AddEvent(ufoSpawner, halting: false);
		eventList.SetLastEventAsCheckPoint();
		WaitEvent waitEvent2 = new WaitEvent(((GameComponent)this).Game, 0.1f);
		waitEvent2.LinkWith(ufoSpawner);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 0.5f, big: false);
		ufoSpawner.SetupMars();
		ufoSpawner.SetupFastEntry();
		waitEvent2.LinkWith(ufoSpawner);
		eventList.AddEvent(ufoSpawner, halting: false);
		BonusSpawner bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 0f, 0.1f, randomly: true);
		...
		Wait(3f);
		StationaryWave(1f, 3f, 0f, 1f, 0f, 0f);
		gameEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning);
		gameEvent.SetupAsWarning((float)Math.PI / 8f);
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
		waitEvent = new WaitEvent(((GameComponent)this).Game, 3f);
		...
		waitEvent = new WaitEvent(((GameComponent)this).Game, 10f);
		eventList.AddEvent(waitEvent, halting: true);
		waitEvent.OnFinished += slowdown;
		eventList.AddHalt();
		gameEvent = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent, halting: false);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 25f, 2.1f, big: false);
		ufoSpawner.SetupMarsWest();
		eventList.AddEvent(ufoSpawner, halting: false);
		eventList.SetLastEventAsCheckPoint();
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 25f, 0.15f, big: true);
		ufoSpawner.SetupMarsWest();
		eventList.AddEvent(ufoSpawner, halting: false);
		bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 25f, 0.2f, randomly: true);
		eventList.AddEvent(bonusSpawner, halting: false);
		Wait(5f);
		StationaryWave(20f, 0.5f, 0f, 0f, 0f, 1f);
		waitEvent = new WaitEvent(((GameComponent)this).Game, 6f);
		eventList.AddEvent(waitEvent, halting: true);
		waitEvent.OnFinished += speedup;
		eventList.AddHalt();
		gameEvent = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(gameEvent, halting: false);
		waitEvent = new WaitEvent(((GameComponent)this).Game, 2f);
		eventList.AddEvent(waitEvent, halting: true);
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		gameEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning);
		...
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
		MarsBossSpawner marsBossSpawner = new MarsBossSpawner(((GameComponent)this).Game);
		Wait(3f);
		StationarySpawner stationarySpawner = new StationarySpawner(((GameComponent)this).Game, 560f, 0f, 0.8f);
		...
		eventList.AddEvent(waitEvent, halting: true);
		eventList.AddHalt();
		bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 0f, 0.2f, randomly: true);
		bonusSpawner.SetMars();
		...
		Wait(5f);
		UnlockEvent gameEvent2 = new UnlockEvent(((GameComponent)this).Game, "Paratroopers", Unlockables.Items.Paratrooper, AnimatedMessage.UnlockType.challenge, level);
		...
		eventList.SetLastEventAsCheckPoint();
		FlyingSpiderEvent gameEvent3 = new FlyingSpiderEvent(((GameComponent)this).Game, 0f, 5.5f, isbackground: true);
		eventList.AddEvent(gameEvent3, halting: false);
		Wait(4f);
		FlyingSpiderEvent gameEvent4 = new FlyingSpiderEvent(((GameComponent)this).Game, 0f, 2f, isbackground: false);
		eventList.AddEvent(gameEvent4, halting: false);
		Wait(2.5f);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 1.6f, big: false);
		ufoSpawner.SetupMarsWest();
		eventList.AddEvent(ufoSpawner, halting: false);
		bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 0f, 0.2f, randomly: false);
		eventList.AddEvent(bonusSpawner, halting: false);
		Wait(25f);
		SweepUFOSpawner sweepUFOSpawner = new SweepUFOSpawner(((GameComponent)this).Game, 35f, 0.13f);
		...
		eventList.SetLastEventAsCheckPoint();
		gameEvent = new MessageEvent(((GameComponent)this).Game, "Danger!", SoundManager.Texts.Danger);
		eventList.AddEvent(gameEvent);
		gameEvent.SetupAsWarning(0f);
		waitEvent = Wait(4f);
		waitEvent.OnFinished += beesSoundOff;
		waitEvent.OnFinished += halt;
		SpiderBossEvent spiderBossEvent = new SpiderBossEvent(((GameComponent)this).Game);
		eventList.AddEvent(spiderBossEvent, halting: false);
		Wait(8f);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 2f, big: false);
		eventList.AddEvent(ufoSpawner, halting: false);
		spiderBossEvent.LinkWith(ufoSpawner);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 0.2f, big: true);
		eventList.AddEvent(ufoSpawner, halting: false);
		spiderBossEvent.LinkWith(ufoSpawner);
		bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 0f, 0.08f, randomly: false);
		eventList.AddEvent(bonusSpawner, halting: false);
		spiderBossEvent.LinkWith(bonusSpawner);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 0f, 0.15f, big: true);
		...
		Wait(2f);
		gameEvent2 = new UnlockEvent(((GameComponent)this).Game, "Base Pressure", Unlockables.Items.OwnLevel, AnimatedMessage.UnlockType.challenge, level);
		eventList.AddEvent(gameEvent2, halting: true);
		eventList.AddHalt();
		gameEvent2 = new UnlockEvent(((GameComponent)this).Game, "Turbo", Unlockables.Items.Turbo, AnimatedMessage.UnlockType.cheat, level);
		eventList.AddEvent(gameEvent2, halting: true);
		eventList.AddHalt();
		gameEvent2 = new UnlockEvent(((GameComponent)this).Game, "Next Mission!", Unlockables.Items.Level3, AnimatedMessage.UnlockType.level, level);
		eventList.AddEvent(gameEvent2, halting: true);
		eventList.AddHalt();
		gameEvent2 = new UnlockEvent(((GameComponent)this).Game, "Insane Difficulty", Unlockables.Items.InsaneDifficulty, AnimatedMessage.UnlockType.difficulty, level);
		eventList.AddEvent(gameEvent2, halting: true);
		eventList.AddHalt();
	...
	{
		MarsBoss marsBoss = MarsBoss.NewMarsBoss(Collection, ((GameComponent)this).Game);
		marsBoss.Setup(MarsBoss.BossPosition.left);
		Collection.Add((GameComponent)(object)marsBoss);
		marsBoss = MarsBoss.NewMarsBoss(Collection, ((GameComponent)this).Game);
	...
	{
		StationarySpawner stationarySpawner = new StationarySpawner(((GameComponent)this).Game, 560f, time, chance);
	...
	{
		WaitEvent waitEvent = new WaitEvent(((GameComponent)this).Game, time);
		eventList.AddEvent(waitEvent, halting: true);
		eventList.AddHalt();
		return waitEvent;
	}
	...
	{
		BonusSpawner bonusSpawner = new BonusSpawner(((GameComponent)this).Game, 1f, 0.5f, randomly: false);
		bonusSpawner.SetMars();
		eventList.AddEvent(bonusSpawner, halting: false);
		UfoSpawner ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 3f, fastufochance, big: false);
		ufoSpawner.SetupMars();
		ufoSpawner.SetupFastEntry();
		eventList.AddEvent(ufoSpawner, halting: true);
		ufoSpawner = new UfoSpawner(((GameComponent)this).Game, 3f, normalufochance, big: false);
		ufoSpawner.SetupMars();
		eventList.AddEvent(ufoSpawner, halting: true);
		eventList.AddHalt();
	}
	...
	{
		StationaryBoss component = StationaryBoss.NewAlien(Collection, ((GameComponent)this).Game);
