...
internal class Level3 : GameScene
{
	...
	protected override void PreloadGraphicalContent()
	{
		...
		preloadBattleSkull = BattleSkull.NewBattleSkull(Collection, ((GameComponent)this).Game);
	...
	{
		WaitEvent waitEvent = new WaitEvent(((GameComponent)this).Game, 0.1f);
		...
		SkullSpawner gameEvent = new SkullSpawner(((GameComponent)this).Game, 10f, 1f, maze: false, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 10f, 2f, maze: false, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: true);
		eventList.AddHalt();
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 20f, 3.3f, maze: false, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: true);
		gameEvent.OnFinished += speedup;
		eventList.AddHalt();
		Wait(5f);
		MessageEvent messageEvent = new MessageEvent(((GameComponent)this).Game);
		eventList.AddEvent(messageEvent, halting: false);
		messageEvent.OnFinished += swapBG1;
		Wait(1.5f);
		messageEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning);
		eventList.AddEvent(messageEvent, halting: false);
		messageEvent.SetupAsWarning(-(float)Math.PI / 2f);
		Wait(0.2f);
		messageEvent = new MessageEvent(((GameComponent)this).Game, "Danger!", SoundManager.Texts.Nothing);
		eventList.AddEvent(messageEvent, halting: false);
		...
		Wait(3f);
		Walls walls = new Walls(((GameComponent)this).Game, 0);
		eventList.AddEvent(walls, halting: true);
		eventList.SetLastEventAsCheckPoint();
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 0f, 1f, maze: true, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: false);
		walls.LinkWith(gameEvent);
		BattleSkullEvent gameEvent2 = new BattleSkullEvent(((GameComponent)this).Game, 0f, 0.5f);
		eventList.AddEvent(gameEvent2, halting: false);
		eventList.AddHalt();
		walls.LinkWith(gameEvent2);
		Wait(6f);
		messageEvent = new MessageEvent(((GameComponent)this).Game, "Get ready!", SoundManager.Texts.GetReady);
		eventList.AddEvent(messageEvent, halting: false);
		messageEvent.OnFinished += swapBG2;
		walls = new Walls(((GameComponent)this).Game, 1);
		eventList.AddEvent(walls, halting: true);
		eventList.SetLastEventAsCheckPoint();
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 0f, 3f, maze: true, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: false);
		walls.LinkWith(gameEvent);
		eventList.AddHalt();
		Wait(4f);
		messageEvent = new MessageEvent(((GameComponent)this).Game);
		...
		eventList.SetLastEventAsCheckPoint();
		eventList.AddHalt();
		StarMineSpawner starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 20f, 0.7f);
		eventList.AddEvent(starMineSpawner);
		eventList.AddHalt();
		starMineSpawner.OnFinished += speedup;
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 15f, 1.4f);
		eventList.AddEvent(starMineSpawner);
		eventList.AddHalt();
		eventList.SetLastEventAsCheckPoint();
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 15f, 2f);
		eventList.AddEvent(starMineSpawner);
		eventList.AddHalt();
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 20f, 2.5f);
		eventList.AddEvent(starMineSpawner);
		eventList.AddHalt();
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 5f, 0.7f);
		eventList.AddEvent(starMineSpawner, halting: false);
		starMineSpawner.OnFinished += bossspeed;
		eventList.SetLastEventAsCheckPoint();
		messageEvent = new MessageEvent(((GameComponent)this).Game, "Danger!", SoundManager.Texts.Danger);
		messageEvent.SetupAsWarning(-(float)Math.PI / 2f);
		eventList.AddEvent(messageEvent, halting: false);
		Wait(5f);
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 0f, 0.1f, maze: false, bonusonly: true);
		eventList.AddEvent(gameEvent, halting: false);
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 0f, 0.75f);
		eventList.AddEvent(starMineSpawner, halting: false);
		...
		Wait(5f);
		UnlockEvent gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Crazy Game", Unlockables.Items.CrazyGame, AnimatedMessage.UnlockType.challenge, level);
		...
		gameEvent = new SkullSpawner(((GameComponent)this).Game, 0f, 0.8f, maze: true, bonusonly: false);
		eventList.AddEvent(gameEvent, halting: false);
		starMineSpawner = new StarMineSpawner(((GameComponent)this).Game, 0f, 0.6f);
		eventList.AddEvent(starMineSpawner, halting: false);
		walls = new Walls(((GameComponent)this).Game, 3);
		eventList.AddEvent(walls, halting: true);
		eventList.AddHalt();
		walls.LinkWith(gameEvent);
		walls.LinkWith(starMineSpawner);
		Wait(1f);
		gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Boss Train", Unlockables.Items.BossTrain, AnimatedMessage.UnlockType.challenge, level);
		...
		BrainBossHard();
		FakeBossEasy();
		gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Power Up", Unlockables.Items.PowerUp, AnimatedMessage.UnlockType.cheat, level);
		eventList.AddEvent(gameEvent3, halting: true);
		eventList.AddHalt();
		gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Insane Difficulty", Unlockables.Items.HarderDifficulties, AnimatedMessage.UnlockType.difficulty, level);
		eventList.AddEvent(gameEvent3, halting: true);
		eventList.AddHalt();
		gameEvent3 = new UnlockEvent(((GameComponent)this).Game, "Insane Difficulty", Unlockables.Items.InsaneDifficulty, AnimatedMessage.UnlockType.difficulty, level);
		eventList.AddEvent(gameEvent3, halting: true);
		eventList.AddHalt();
	...
	private void FakeBossEasy()
	{
		...
		MessageEvent messageEvent = new MessageEvent(((GameComponent)this).Game, "Warning!", SoundManager.Texts.Warning);
		messageEvent.SetupAsWarning(-(float)Math.PI / 2f);
		eventList.AddEvent(messageEvent);
	...
	{
		WaitEvent waitEvent = new WaitEvent(((GameComponent)this).Game, 3f);
		eventList.AddEvent(waitEvent);
		eventList.AddHalt();
		...
		eventList.AddHalt();
		eventList.MakeConditional(waitEvent, Settings.DifficultyLevel.Hard, Settings.DifficultyLevel.Inzane);
		Walls walls = new Walls(((GameComponent)this).Game, 4);
		...
		walls = new Walls(((GameComponent)this).Game, 4);
		eventList.AddEvent(walls);
		eventList.AddHalt();
		walls.OnFinished += bossspeed;
		eventList.MakeConditional(walls, Settings.DifficultyLevel.Hard, Settings.DifficultyLevel.Inzane);
		BrainBossSpawner brainBossSpawner = new BrainBossSpawner(((GameComponent)this).Game, challenge: false);
