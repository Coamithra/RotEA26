...
internal class MenuSubWithSkull : MenuSub1
{
	...
	public override void DrawMenu(GameTime gameTime, float yoffset)
	{
		...
		float num = ((GameComponent)this).Game.GraphicsDevice.PresentationParameters.BackBufferWidth;
		float num2 = ((GameComponent)this).Game.GraphicsDevice.PresentationParameters.BackBufferHeight;
		...
		((Rectangle)(ref dest))._002Ector(num4, num3, num5, num6);
		Rectangle dest2 = default(Rectangle);
		((Rectangle)(ref dest2))._002Ector(num8, num7, num9, num10);
