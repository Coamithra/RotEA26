...
public class Powerup : AlienDrawableGameComponent
{
		...
		: base(game)
	{
		...
		((DrawableGameComponent)this).DrawOrder = 12;
	...
	public override void Initialize()
	{
		...
		//IL_0032: Unknown result type (might be due to invalid IL or missing references)
		base.Initialize();
		color = new Color(((Color)(ref color)).R, ((Color)(ref color)).G, ((Color)(ref color)).B, (byte)204);
		base.Collides = true;
		taken = false;
	}
	...
	public override void Update(GameTime gameTime)
	{
		...
		if (limitspeed)
		{
			...
			base.Speed = MathHelper.Min(((Vector2)(ref backgroundSpeed)).Length() + 0.018000001f, speedLimitedAt);
		}
		else
		{
			Vector2 backgroundSpeed2 = oracle.BackgroundSpeed;
			base.Speed = ((Vector2)(ref backgroundSpeed2)).Length();
		}
