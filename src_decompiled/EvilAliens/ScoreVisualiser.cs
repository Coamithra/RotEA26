...
public class ScoreVisualiser : DrawableGameComponent, IScoreService, IComponentWatcher
{
	...
	private Vector2 livePosition(int i)
	{
		...
		return new Vector2((float)(316 + i * 24 + 12), (float)(((Rectangle)(ref General.SafeZone)).Bottom - 10));
	}
	...
	protected override void LoadContent()
	{
		...
		bomb = content.Load<Texture2D>("GFX/Sprites/option");
	...
	private Vector2 getScorePosition(int player, out Color color)
	{
		...
		{
		case 0:
			((Vector2)(ref result))._002Ector((float)((Rectangle)(ref safeZone)).Left, (float)((Rectangle)(ref safeZone)).Top);
			color = Color.Blue;
			break;
		case 1:
			((Vector2)(ref result))._002Ector((float)(((Rectangle)(ref safeZone)).Right - 160), (float)((Rectangle)(ref safeZone)).Top);
			color = Color.Purple;
			break;
		case 2:
			((Vector2)(ref result))._002Ector((float)((Rectangle)(ref safeZone)).Left, (float)(((Rectangle)(ref safeZone)).Bottom - 65));
			color = Color.Red;
			break;
		case 3:
			((Vector2)(ref result))._002Ector((float)(((Rectangle)(ref safeZone)).Right - 160), (float)(((Rectangle)(ref safeZone)).Bottom - 65));
			color = Color.Orange;
			break;
		default:
	...
	public override void Draw(GameTime gameTime)
	{
		...
		if (phototimer.Active)
		{
			...
			((Color)(ref color2))._002Ector(new Vector4(((Color)(ref snapshotcolor)).ToVector3(), num));
			spriteBatch.Draw(photocamera, new Vector2(400f, (float)((Rectangle)(ref General.SafeZone)).Top + (float)photocamera.Height / 2f), 0f, 1f, center: true, color2);
		}
		spriteBatch.BlendMode = (SpriteBlendMode)1;
	}
	...
	private void drawPressStart(GameTime gameTime, int i, ref Color playercolor, ref Vector2 startpos)
	{
		...
		if (showPressStartTimer.Active)
		{
			...
			Vector4 val = ((Color)(ref playercolor)).ToVector4();
			Color aliceBlue = Color.AliceBlue;
			Color color = default(Color);
			((Color)(ref color))._002Ector(Vector4.Lerp(val, ((Color)(ref aliceBlue)).ToVector4(), num));
	...
	private void DrawStr(string str, Vector2 position, float scale, float alpha, Color color)
	{
		...
		if (color == Color.White)
		{
			...
			((Color)(ref color2))._002Ector((byte)0, (byte)0, byte.MaxValue, b);
			((Color)(ref color3))._002Ector((byte)173, (byte)216, (byte)230, b);
		}
		else
		{
			((Color)(ref color2))._002Ector(new Vector4(((Color)(ref color)).ToVector3(), alpha * 0.55f));
			((Color)(ref color3))._002Ector(new Vector4(((Color)(ref color)).ToVector3() + new Vector3(0.65f, 0.65f, 0.65f), alpha * 0.55f));
		}
