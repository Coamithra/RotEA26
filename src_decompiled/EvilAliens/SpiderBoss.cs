...
internal class SpiderBoss : AlienDrawableGameComponent
{
	...
	public override void Draw(GameTime gameTime)
	{
		...
		if (spiderBossState == SpiderBossState.dead)
		{
			...
			((Color)(ref val))._002Ector(new Vector4(1f, 1f, 1f, MathHelper.Lerp(0f, 1f, stateTimer.TimeLeft * 3f / stateTimer.Duration)));
	...
	public override void Update(GameTime gameTime)
	{
		...
		case SpiderBossState.flyleft:
			...
			if (base.Position.X < -345f && stateTimer.Finished)
			{
				...
				ResetTimer(4f);
				sfxplayed = false;
				AnimatedMessage animatedMessage3 = AnimatedMessage.NewAnimatedMessage(collection, ((GameComponent)this).Game);
		...
		case SpiderBossState.flyright:
			...
			{
				AnimatedMessage animatedMessage2 = AnimatedMessage.NewAnimatedMessage(collection, ((GameComponent)this).Game);
	...
	private void rumble(Vector2 Position)
	{
		...
		for (int i = 0; i < oracle.Players; i++)
		{
			...
			((Vector2)(ref val))._002Ector(0.35f, 0.35f);
			((Vector2)(ref val2))._002Ector(0.15f, 0.15f);
