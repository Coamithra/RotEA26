	...
	private void DrawEntryAt(int entry, float step)
	{
		...
		if (!(step > 1f || step < 0f))
		{
			...
			if (step > 1f)
			{
				...
				((Vector2)(ref position))._002Ector(MathHelper.Lerp(800f, 400f, num), 200f);
				Color color = default(Color);
				((Color)(ref color))._002Ector(new Vector4(1f, 1f, 1f, MathHelper.Lerp(0.3f, 1f, num)));
				...
				((Vector2)(ref scale))._002Ector(num3 * num2, num4 * num2);
			...
			else
			{
				...
				((Vector2)(ref position2))._002Ector(MathHelper.Lerp(0f, 400f, num5), 200f);
				Color color2 = default(Color);
				((Color)(ref color2))._002Ector(new Vector4(1f, 1f, 1f, MathHelper.Lerp(0.3f, 1f, num5)));
				...
				((Vector2)(ref scale2))._002Ector(num7 * num6, num8 * num6);
				base.SpriteBatch.BlendMode = (SpriteBlendMode)0;
	...
	private void DrawAchievementText(int entry, Vector2 position, float scale, Color color)
	{
		...
		if (Achievements.GetInstance().Data[levels[entry]].isFinished)
		{
			...
			if (difficultyLevel > Achievements.GetInstance().Data[levels[entry]].difficulty)
			{
				...
				((Color)(ref color))._002Ector(new Vector4(((Color)(ref gray)).ToVector3(), (float)(int)((Color)(ref color)).A / 255f));
			}
			else
			{
				Color limeGreen = Color.LimeGreen;
				((Color)(ref color))._002Ector(new Vector4(((Color)(ref limeGreen)).ToVector3(), (float)(int)((Color)(ref color)).A / 255f));
			}
