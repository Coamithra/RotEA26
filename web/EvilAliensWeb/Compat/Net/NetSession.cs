...
namespace EvilAliensWeb.Compat.Net
{
    ...
    public static partial class NetSession
    {
        ...
        // v11 (card e79bb994): a per-SAMPLE flags byte on every world-snapshot entry
        // (NetProtocol.NetSnapshotFlags), carrying the host's teleport marker. The entry layout
        // moved, so a v10 peer would mis-parse every snapshot -- a hard incompatibility.
