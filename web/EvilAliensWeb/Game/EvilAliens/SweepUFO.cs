...
internal class SweepUFO : KillableAlien
{
	...
	{
		EvilAliensWeb.Compat.Net.NetChargeGlow.Drive(ref g, ref netEasedChargeOffset, netCharging, netChargeOffset, netChargeWindup, netChargeSize, 1f, collection, base.Game, base.Position, (float)gameTime.ElapsedGameTime.TotalMilliseconds);
	}
}
